 ...
 *
 *     git | https://github.com/jbeargraphics/LessCssLibrary/jBearBasicMixins
 *
 */

 This section contains a basic Css reset as well as some basic Mixins for Less.

 The section will be updated continuously.